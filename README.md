...
[![Version](https://img.shields.io/badge/version-1.0.1-blue)](https://github.com/APecme/Telegram_Depiler/releases/tag/v1.0.1)
...
> **最新版本 v1.0.1** - 新增表单验证、代理类型选择和 Bot 内联键盘分页功能 🎉
